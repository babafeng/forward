  ...
  "nodes": [
    {
      ...
      "subscribes": [
        "/tmp/aaa.txt",
        "http://43.162.87.125:8080",
        "https://clash.faceioclash.top/"
      ],
      "forward": "vless://0e467f5f-0a5c-44f8-82a5-07f803d161e8@us.babafeng.icu:443?encryption=none&flow=xtls-rprx-vision&fp=chrome&pbk=A0ADElLyacApk2_prdYRh_lsOhG7dMeEVLc_NVFRGA8&security=reality&sid=d003cb13&sni=swscan.apple.com&type=tcp&mux=true&mux_max_streams=64&mux_idle=120s#VLESS-Reality"
    }
  ],
  "debug": false
}`))
	...
	if forward.Scheme != "vless" || forward.Host != "us.babafeng.icu" || forward.Port != 443 {
